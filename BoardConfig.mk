...
# Graphics
BOARD_EGL_CFG := device/moto/shadow/prebuilt/etc/egl.cfg
...
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := device/moto/shadow/releasetools/shadow_img_from_target_files
